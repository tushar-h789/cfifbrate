...
export default function Partners() {
  return (
    <section className="container bg-[#F6DC0E] py-10 rounded-xl text-center">
      <h2 className="text-secondary_text font-medium font-hind text-5xl ">
        Our Partners
      </h2>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-0 my-3 items-center mx-10">
